...
export default function Navbar() {
  return (
    <div className="navbar">
      ...
      <Link className="navbar-text clickable" href="/#home">
        Home
      </Link>
      <Link className="navbar-text clickable" href="/#about">
        About
      </Link>
      <Link className="navbar-text clickable" href="/#projects">
        Projects
      </Link>
      <Link className="navbar-text clickable" href="/#education">
        Education
      </Link>

      <div className="navbar-item right">
        <Link
          className="navbar-resume-download-btn"
